        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-300 mb-4">
              I'm Vikas Prajapat, a passionate Full Stack Developer currently pursuing my B.Tech in Computer Science and Engineering at Parul University with a strong CGPA of 8.7. I specialize in creating responsive web applications using modern technologies.
            </p>
            <p className="text-gray-300 mb-4">
