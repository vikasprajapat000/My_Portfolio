...
import { FaGithub, FaLinkedin, FaEnvelope, FaHeart, FaChevronUp, FaCode, FaRegCopyright, FaFacebook, FaInstagram } from 'react-icons/fa';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-4 pt-4">
                            <a 
                                href="https://www.linkedin.com/in/vikas-prajapat-4a9795257/" 
                                target="_blank" 
                            ...
                            <a 
                                href="https://www.instagram.com/its_your_.vikas._/" 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-110 group"
                            ...
                            <a 
                                href="https://www.facebook.com/profile.php?id=100063733571426" 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-110 group"
                                aria-label="Facebook"
                            >
                                <FaFacebook className="h-5 w-5 text-sky-400 group-hover:text-sky-300" />
                            </a>
                            <a 
                                href="mailto:vikas93prajapat@gmail.com" 
                                className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-110 group"
                                aria-label="Email"
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center gap-3 hover:translate-x-1 transition-transform">
                                ...
                                <span className="text-gray-400">vikas93prajapat@gmail.com</span>
                            </li>
                            <li className="flex items-center gap-3 hover:translate-x-1 transition-transform">
                                <div className="p-2 rounded-full bg-white/5 flex-shrink-0">
                                    <FaGithub className="text-gray-300 h-4 w-4" />
                                </div>
                                <a href="https://github.com/vikasprajapat000" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-400 transition-colors">
                                    github.com/vikasprajapat000
                                </a>
                            </li>
                            <li className="flex items-center gap-3 hover:translate-x-1 transition-transform">
                                <div className="p-2 rounded-full bg-white/5 flex-shrink-0">
                                ...
                                <a href="https://www.linkedin.com/in/vikas-prajapat-4a9795257/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-400 transition-colors">
                                    linkedin.com/in/vikas-prajapat-4a9795257/
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="pt-8 mt-8 border-t border-gray-800">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <p className="text-gray-500 text-sm flex items-center">
                            ...
                            by <span className="text-orange-400 ml-1">Vikas Prajapat 😊</span>
                        </p>
                    </div>
                </div>
            </div>
