...
import { FaInstagram, FaReact, FaNodeJs, FaHtml5, FaFacebook } from "react-icons/fa";
...
const Home = () => {
    ...
    useEffect(() => {
        document.title = "Vikas Prajapat | Developer";
    ...
    const handleDownload = () => {
        ...
        const downloadResume = () => {
            try {
                ...
                link.href = "/Vikas_prajapt_resume.pdf";
                link.download = "Vikas-Prajapat-Resume.pdf";
                        ...
                        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                            ...
                            <div className="order-2 md:order-1 text-center md:text-left mt-8 md:mt-0">
                                ...
                                <div className="mt-3 md:mt-4 overflow-hidden">
                                    ...
                                    🙋‍♂️, I'm <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-500">Vikas Prajapat</span>
                                    </h1>
                                </div>
